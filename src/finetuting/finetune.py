...
class SummarizationModule(BaseTransformer):
    ...
    def __init__(self, hparams, **kwargs):
       ...
       #save_git_info(self.hparams.output_dir)
        ...
        self.target_lens = {
            ...
            "valid": self.hparams.val_max_target_length,
            "test": self.hparams.test_max_target_length,
        }
        assert self.target_lens["train"] <= self.target_lens["valid"], f"target_lens: {self.target_lens}"
    ...
    def validation_epoch_end(self, outputs, prefix="valid") -> Dict:
        self.step_count += 1
    ...
    def val_dataloader(self) -> DataLoader:
        return self.get_dataloader("valid", batch_size=self.hparams.eval_batch_size)
